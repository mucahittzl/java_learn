...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        DateTimeFormatter dtf=DateTimeFormatter.ofPattern("dd//MMMM//YYYY");//gun ayismi ve yıl formatlandı
        System.out.println("dtf.format(ldt) = " + dtf.format(ldt));//dtf.format(ldt) = 25//Ekim//22
        DateTimeFormatter dtf1=DateTimeFormatter.ofPattern("hh:mm:ss a");//saat dakika ve sanıye am format tanımlandı
        System.out.println("dtf1.format(ldt) = " + dtf1.format(ldt));//dtf1.format(ldt) = 11:24:18 ÖS
