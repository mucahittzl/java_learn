...
public class C05_clear_size_isEmpty {
    public static void main(String[] args) {
        ...
        //map.entrySize();->Girilen map'in entry(giris:eleman) sayısını return eder.
        //map.clear();->Girilen map'in tum entry(giris:eleman) siler.
        //map.isEmpty();->Girilen map'in entry(giris:eleman) varlıgını kontrol eden boolean return eder.
