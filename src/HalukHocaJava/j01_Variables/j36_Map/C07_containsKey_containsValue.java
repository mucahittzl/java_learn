...
public class C07_containsKey_containsValue {
    public static void main(String[] args) {
        ...
        //map.containsKey();->Girilen key değerinin map'de varlıgını kontrol eder boolean return eder.
        //map.containsValue();->Girilen value değerinin map'de varlıgını kontrol eder boolean return eder.
        ...
        System.out.println("hm.containsValue(\"ebık gabık Euro\") = " + hm.containsValue("ebık gabık Euro"));//false
    }
}
