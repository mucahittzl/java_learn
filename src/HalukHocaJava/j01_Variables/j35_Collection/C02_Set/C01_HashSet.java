...
public class C01_HashSet {
    ...
    public static void main(String[] args) {
        ...
        HashSet<String>hs1=new HashSet<>(Arrays.asList("ercan","yakup","adem","rukıye","nur"));//eleman ataması yapılan bir hashSet
        //Set print etme...
        System.out.println("hs1 = " + hs1);//hs1 = [adem, ercan, yakup, nur, rukıye]
        hs1.add("kevser");
        System.out.println(hs1);//[adem, ercan, yakup, kevser, nur, rukıye]
        hs1.add("adem");
        System.out.println(hs1);//[adem, ercan, yakup, kevser, nur, rukıye]
        hs1.add(null);
        hs1.add(null);
        hs1.add(null);
        System.out.println(hs1);//[null, adem, ercan, yakup, kevser, nur, rukıye]

        HashSet<String>hs2=new HashSet<>(Arrays.asList("basarı","gayrete","asıktır"));
        System.out.println("hs2 = " + hs2);
        hs1.addAll(hs2);
        System.out.println("hs1 = " + hs1);//hs1 = [null, gayrete, adem, ercan, yakup, kevser, nur, rukıye, basarı, asıktır]

        System.out.println("hs1.remove(\"asıktır\") = " + hs1.remove("asıktır"));//olan eleman ->true
        System.out.println("hs1.remove(\"Aşıktır\") = " + hs1.remove("Aşıktır"));//olmayan eleman ->false
        System.out.println("hs1 = " + hs1);//hs1 = [null, gayrete, adem, ercan, yakup, kevser, nur, rukıye, basarı] (asıktır)SİLİNDİ

        System.out.println("hs1.removeAll(hs2) = " + hs1.removeAll(hs2));//true
        System.out.println("hs1 = " + hs1);//hs1 = [null, adem, ercan, yakup, kevser, nur, rukıye] (hs2 HEPSİ SİLİNDİ)
        ...
        System.out.println("hs2.hashCode() = " + hs2.hashCode());//hs2.hashCode() = -2109457896
