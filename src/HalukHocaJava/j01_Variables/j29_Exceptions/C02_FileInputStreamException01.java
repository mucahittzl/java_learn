 ...
 */
   ...
   // public static void main(String[] args) throws FileNotFoundException {//read() method import öncesi child exception
        FileInputStream fis=new FileInputStream("C:\\Users\\90552\\IdeaProjects\\java_learn\\src\\HalukHocaJava.j01_Variables.j29_Exceptions\\ebikGabık");
        ...
        /*
        Eğer bir method'da Checked (CTE riski olan excp.) exception varsa method signature(method name'den sonraki bölüm) hata uyarısı verir altını çizer.
        komutun derlenmesine izin vermez ve kod üzerine gelindiğinde Add...exception handle etme tavsiye eder.Otomatik throws exception eklenir.
        Bu şekilde method'u call eden komutlar try-catch alınması garanti edilmiş olur.
         */
