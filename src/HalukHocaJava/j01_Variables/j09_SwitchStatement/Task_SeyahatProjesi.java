   ...
   todo    Frankfurt girildiyse,
      ...
      "Rota = Köln" yazdırın.
       ...
       case:1  ise
        ...
        double bakiye = 100, frnkfurtucret = (60 / 20) * 5, kölnucret = (80 / 20) * 5;
        switch (hedef) {

            case "FRANKFURT":
                System.out.println("rota frankfurt");
                System.out.println("frankfurt ucret" + frnkfurtucret + "euro");
                System.out.println("kaç kişilik bilet alacaksınız");
                int kişi = scan.nextInt();
                switch (kişi) {
                    case 1:
                        System.out.println("1 kişilik bilet ücreti" + frnkfurtucret);
                        System.out.println("guncel bakıyenız:" + (bakiye - frnkfurtucret));
                        break;
                    case 2:
                        System.out.println("2 kişilik ilet ücreti" + frnkfurtucret * 2);
                        System.out.println("guncel bakıyenız:" + (bakiye - (frnkfurtucret + frnkfurtucret)));
                    default:
            ...
            case "KÖLN":
                ...
                System.out.println("köln ucret" + frnkfurtucret + "euro");
                System.out.println("kaç kişilik bilet alacaksınız");
                int kişii = scan.nextInt();
                switch (kişii) {
                    case 1:
                        System.out.println("1 kişilik bilet ücreti" + kölnucret);
                        System.out.println("guncel bakıyenız:" + (bakiye - kölnucret));
                        break;
                    case 2:
                        System.out.println("2 kişilik ilet ücreti" + kölnucret * 2);
                        System.out.println("guncel bakıyenız:" + (bakiye - (kölnucret + kölnucret)));
                    default:
                        System.out.println("hatalı gırıs yaptınız");
                }
