...
int a=7; // local variable
     ...
     //  System.out.println(yas); // inst variable değer ataması yapmadan işleme alınmaz non static oldugu ıcın doğrudan çağırılamaz
        System.out.println(kurs);//static variable doğrudan static methoda çağırıldı
